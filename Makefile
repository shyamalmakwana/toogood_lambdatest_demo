...
test_Android1:
	robot --variable platformVersion:10 --variable platformName:Android --variable deviceName:"Galaxy S20" --variable isRealMobile:true --variable visual:true --variable network:false --variable console:false --variable app:"lt://APP10160202521666188016486486" src/scenario/androidTest.robot

test_Android2:
	robot --variable version:10 --variable platform:Android --variable deviceName:"Galaxy S10" --variable isRealMobile:true --variable visual:true --variable network:false --variable console:false --variable app:"lt://APP10160202521666188016486486" src/scenario/androidTest.robot
